  ...
  return (
    <button
      ...
      className={cn(
        ...
        "group-data-[state=collapsed]:group-data-[collapsible=offcanvas]:translate-x-0 group-data-[state=collapsed]:group-data-[collapsible=offcanvas]:after:left-full group-data-[state=collapsed]:group-data-[collapsible=offcanvas]:hover:bg-sidebar",
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:group-data-[state=collapsed]:size-8 group-data-[collapsible=icon]:group-data-[state=collapsed]:p-2 group-data-[collapsible=icon]:group-data-[state=collapsed]:justify-center [&>span]:group-data-[collapsible=icon]:group-data-[state=collapsed]:hidden [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
      ...
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-xs",
        lg: "h-12 text-sm group-data-[collapsible=icon]:group-data-[state=collapsed]:p-0",
      },
    },
    defaultVariants: {
      variant: "default",
