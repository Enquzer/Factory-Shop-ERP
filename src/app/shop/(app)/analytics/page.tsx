...
import { ShoppingCart, Target, DollarSign, Loader2, Package, CheckCheck, TrendingUp, TrendingDown } from 'lucide-react';
import { Bar, BarChart, ResponsiveContainer, XAxis, YAxis, Tooltip } from "recharts";
import { ChartContainer, ChartTooltipContent } from "@/components/ui/chart";
import { getShopById, type Shop } from '@/lib/shops';
import { parseISO, startOfWeek, format, isThisMonth, startOfMonth, subWeeks, endOfWeek, subMonths, endOfMonth } from 'date-fns';
    ...
    const analytics = useMemo(() => {
        ...
        const endOfLastWeek = endOfWeek(subWeeks(now, 1), { weekStartsOn: 1 });
         ...
         const thisWeekSales = orders
            .filter(o => { const d = parseISO(o.date); return d >= startOfThisWeek && d <= endOfThisWeek; })
            .reduce((sum, o) => sum + o.amount, 0);

        const lastWeekSales = orders
            .filter(o => { const d = parseISO(o.date); return d >= startOfLastWeek && d <= endOfLastWeek; })
            .reduce((sum, o) => sum + o.amount, 0);
