  ...
  try {
    ...
    await db.exec(`
      CREATE TABLE IF NOT EXISTS tbl_IE_Machines (
        ...
        unit TEXT, -- units per hour, meters per minute, etc.
        powerRating TEXT,
        dimensions TEXT, -- width x depth x height
        weight REAL,
        installationArea TEXT,
        maintenanceSchedule TEXT,
        status TEXT DEFAULT 'active',
        department TEXT,
        lineSection TEXT, -- Cutting, Sewing, Finishing, Packing
        createdBy TEXT,
    ...
    await db.exec(`
      CREATE TABLE IF NOT EXISTS tbl_IE_Machine_Layouts (
        ...
        orderId TEXT,
        productCode TEXT,
        section TEXT, -- Cutting, Sewing, Finishing, Packing
        machinePositions TEXT, -- JSON array of machine positions
        createdBy TEXT,
        createdAt DATETIME DEFAULT CURRENT_TIMESTAMP,
        updatedAt DATETIME DEFAULT CURRENT_TIMESTAMP
      )
...
async function seedMachines(db) {
  try {
    ...
    const existingMachines = await db.get('SELECT COUNT(*) as count FROM tbl_IE_Machines');
